...
FONT = pygame.font.SysFont("comincsans", 24)
    ...
    def draw(self, win):
        ...
        if len(self.orbit) > 2:
            ...
            for point in self.orbit:
                xa, ya = point
                xx = xa * self.SCALE + WIDTH / 2
                yy = ya * self.SCALE + HEIGHT / 2
                updated_points.append((xx, yy))
        ...
        if not self.sun:
            ...
            win.blit(distance_text, (x - distance_text.get_width() /
                     2, y - distance_text.get_height() / 2 - 2 * self.radius))
